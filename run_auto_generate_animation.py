...
def run_auto_generate_animation(blender_executable, script_file, log_file, n_runs):
    for i in range(n_runs):
        ...
        command = [
            ...
            "-mat", "Sun",                # Script arguments
            "-i", "C:/Users/Jedi Knight/Documents/GitHub/AtmosphereAnimations/SunsetAtSea8.blend",
            "-o", "C:/Users/Jedi Knight/Documents/GitHub/AtmosphereAnimations/renders/auto",
